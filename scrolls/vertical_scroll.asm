...
main:
; 
;line:21:vertical_scroll.mfk
;     i0B = $f
    LDA #$F
    STA $80
; 
;line:22:vertical_scroll.mfk
;     os_SDLST = dl.addr
    LDA #lo(dl)
    STA $230
    LDA #hi(dl)
    STA $231
; 
;line:24:vertical_scroll.mfk
;     while true {
.wh__00001:
; 
;line:25:vertical_scroll.mfk
;       while (i0B != 0){
    JMP .he__00006
.wh__00005:
; 
;line:26:vertical_scroll.mfk
;         i0B -= 1
    DEC $80
; 
;line:27:vertical_scroll.mfk
;         antic_vscrol = i0B
    LDA $80
    STA $D405
; 
;line:28:vertical_scroll.mfk
;         wait(3)
    LDA #3
    JSR wait
; 
...
.he__00006:
    ...
    BNE .wh__00005
; 
;line:30:vertical_scroll.mfk
;       wait(50)
    LDA #$32
    JSR wait
; 
;line:31:vertical_scroll.mfk
;       while (i0B < $f){
    JMP .he__00010
.wh__00009:
; 
;line:32:vertical_scroll.mfk
;         i0B += 1
    INC $80
; 
;line:33:vertical_scroll.mfk
;         antic_vscrol = i0B
    LDA $80
    STA $D405
; 
;line:34:vertical_scroll.mfk
;         wait(2)
    LDA #2
    JSR wait
; 
...
wait:
; 
;line:10:vertical_scroll.mfk
;     clc
    CLC
; 
;line:11:vertical_scroll.mfk
;     adc os_RTCLOK.b2
    ADC $14
; 
;line:12:vertical_scroll.mfk
;     .rt_check:
wait$.rt_check:
; 
;line:13:vertical_scroll.mfk
;     cmp os_RTCLOK.b2
    CMP $14
; 
;line:14:vertical_scroll.mfk
;     bne .rt_check
    BNE wait$.rt_check
; 
;line:15:vertical_scroll.mfk
;     rts
    RTS
; 
;line
* = $2050
dl.array:
    !byte $70, $70, $70, $70, $67, lo(text), hi(text), $41, lo(dl), hi(dl)
* = $2080
text.array:
    !byte $E, $E, $E, $2D, $29, $2C, $2C, $26, $2F, $32, $2B, 0, $32, $35, $2C, $25
    !byte $3A, $E, $E, $E
.he__00006                     = $201D
.he__00010                     = $2035
.wh__00001                     = $200E
...
segment.default.length         = $9F6C
segment.default.start          = $2094
text.array                     = $2080
wait                           = $203D
wait$.rt_check                 = $2040
    ; $0000 = __rwdata_end
    ...
    ; $2050 = dl.array
    ; $2080 = text.array
    ; $2094 = segment.default.start
    ; $9F6C = segment.default.length
    ; $BFFA = os_CARTCS
    ; $BFFA = os_CARTCS.lo
    ; $BFFB = os_CARTCS.hi
    ; $BFFC = os_CART
