...
;     copy_block($e080,$4000,80)
    ...
    JSR copy_block
; 
;line:16:countdown_for_benchmark.mfk
;     asm { sei }
    SEI
; 
;line:17:countdown_for_benchmark.mfk
;     antic_nmien = 0
    LDA #0
    STA $D40E
; 
;line:18:countdown_for_benchmark.mfk
;     pia_portb = $fe
    LDA #$FE
    STA $D301
; 
;line:19:countdown_for_benchmark.mfk
;     os_NMIVEC = vbi.addr
    LDA #lo(vbi)
    STA $FFFA
    LDA #hi(vbi)
    STA $FFFB
; 
;line:20:countdown_for_benchmark.mfk
;     run_counter = false
    LDA #0
    STA 4
; 
;line:21:countdown_for_benchmark.mfk
;     antic_nmien = $40
    LDA #$40
    STA $D40E
; 
...
;     set_block($20,5,0)
    ...
    JSR set_block
; 
;line:74:countdown_for_benchmark.mfk
;     set_block($41,7,0)
    LDA #$41
    STA set_block$from
    LDA #7
    ...
    JSR set_block
; 
;line:25:countdown_for_benchmark.mfk
;     lda RTCLOK
    LDA 0
; 
;line:26:countdown_for_benchmark.mfk
;     .rt_check:
.ai__00046pause$.rt_check:
; 
;line:27:countdown_for_benchmark.mfk
;     cmp RTCLOK
    CMP 0
; 
;line:28:countdown_for_benchmark.mfk
;     beq .rt_check
...
.do__00035:
    DEC $46
; 
;line:88:countdown_for_benchmark.mfk
...
;     run_counter = false
    STA 4
; 
;line:99:countdown_for_benchmark.mfk
;     while(true){}
.wh__00041:
    BEQ .wh__00041
; 
...
.wh__00006:
; 
;line:59:countdown_for_benchmark.mfk
...
.wh__00013:
; 
;line:65:countdown_for_benchmark.mfk
;       from[iter0W] = val
    LDY 2
    LDA 3
    CLC
...
;         zpr_4 += 1
    INC $20
; 
;line:52:countdown_for_benchmark.mfk
;         zpr_3 = 0
    LDA #0
    STA $21
; 
...
segment.default.length         = $9E47
segment.default.start          = $21B9
set_block                      = $2119
set_block$from                 = $0086
set_block$size                 = $0084
set_block$val                  = $008A
...
zpr_4                          = $0020
    ...
    ; $218D = .fi__00005
    ; $21B0 = dl.array
    ; $21B9 = segment.default.start
    ; $9E47 = segment.default.length
    ; $BFFA = os_CARTCS
    ; $BFFA = os_CARTCS.lo
    ; $BFFB = os_CARTCS.hi
    ; $BFFC = os_CART
