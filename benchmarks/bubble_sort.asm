...
;     screen = os_SAVMSC
    ...
    STA $84
; 
;line:34:bubble_sort.mfk
;     for i:sorttable {
    LDA #0
    STA $80
.do__00010:
; 
;line:35:bubble_sort.mfk
;       printScore(sorttable[i])
    LDY $80
    LDA sorttable.array, Y
    JSR printScore
; 
;line:34:bubble_sort.mfk
;     for i:sorttable {
    ...
    BNE .do__00010
; 
;line:6:bubble_sort.mfk
;     lda os_RTCLOK.b2
    LDA $14
; 
;line:7:bubble_sort.mfk
;     .rt_check:
.ai__00030pause$.rt_check:
; 
;line:8:bubble_sort.mfk
;     cmp os_RTCLOK.b2
    CMP $14
; 
;line:9:bubble_sort.mfk
;     beq .rt_check
    BEQ .ai__00030pause$.rt_check
; 
;line:39:bubble_sort.mfk
;     os_RTCLOK.b2 = 0
    TYA
    STA $14
; 
;line:41:bubble_sort.mfk
;     for t,253,downto,0{
    LDA #$FE
    STA $83
.do__00013:
    DEC $83
; 
;line:42:bubble_sort.mfk
;       for i,0,to,253{
    LDA #0
    STA $80
.wh__00016:
; 
;line:43:bubble_sort.mfk
;         n1 = sorttable[i]
    LDY $80
    LDA sorttable.array, Y
    STA $81
; 
;line:44:bubble_sort.mfk
;         n2 = sorttable[i+1]
    LDA sorttable.array + 1, Y
    STA $82
; 
;line:45:bubble_sort.mfk
;         if n1>n2 {
    CMP $81
    BCS .fi__00020
; 
...
;     for t,253,downto,0{
    ...
    BNE .do__00013
; 
;line:52:bubble_sort.mfk
;     t = os_RTCLOK.b2
    LDA $14
    STA $83
; 
;line:54:bubble_sort.mfk
;     screen = os_SAVMSC
    LDA $59
    STA $85
    LDA $58
    STA $84
; 
;line:55:bubble_sort.mfk
;     for i:sorttable {
    LDA #0
    STA $80
.do__00023:
; 
;line:56:bubble_sort.mfk
;       printScore(sorttable[i])
    LDY $80
    LDA sorttable.array, Y
    JSR printScore
...
;     for i:sorttable {
    ...
    BNE .do__00023
; 
;line:59:bubble_sort.mfk
;     printScore(t)
    LDA $83
    JSR printScore
; 
;line:61:bubble_sort.mfk
;     while true {}
.wh__00026:
    JMP .wh__00026
; 
...
; 
;line:19:bubble_sort.mfk
;     tmp[1] = val & %00001111
    TYA
    AND #$F
    STA printScore$tmp.array + 1
; 
;line:20:bubble_sort.mfk
;     for iter:tmp {
    LDX #0
.do__00003:
; 
...
;     for iter:tmp {
    ...
    BNE .do__00003
; 
;line:28:bubble_sort.mfk
;     screen[0] = 0
    TYA
    STA ($84), Y
; 
;line:29:bubble_sort.mfk
;     screen += 1
    INC $84
    BNE .in__00009
    INC $85
...
__zeropage_last                = $008D
__zeropage_usage               = $000E
antic_chactl                   = $D401
antic_chbase                   = $D409
antic_dlist                    = $D402
antic_dlist.hi                 = $D403
...
segment.default.length         = $9E01
segment.default.start          = $21FF
sorttable.array                = $2100
t                              = $0083
    ; $0000 = os_LINZBS
    ; $0000 = os_LNFLG
    ...
    ; $0085 = screen.hi
    ; $0086 = __reg
    ; $008A = printScore$iter
    ; $008B = printScore$val
    ; $008C = printScore$tmp.array
    ; $008D = __zeropage_last
    ; $008E = __zeropage_end
    ; $0200 = os_INTABS
    ; $0200 = os_INTABS.lo
    ; $0200 = os_VDSLST
    ...
    ; $21FF = __rwdata_end
    ; $21FF = segment.default.start
    ; $9E01 = segment.default.length
    ; $BFFA = os_CARTCS
    ; $BFFA = os_CARTCS.lo
    ; $BFFB = os_CARTCS.hi
    ; $BFFC = os_CART
