...
dli:
    ...
    PHA 
; 
;line:16:dli_example.mfk
;     gtia_colpf2 = $de
    LDA #$DE
    STA $D018
; 
;line:17:dli_example.mfk
;     antic_wsync = 1
    LDA #1
    STA $D40A
    ; DISCARD_AF
...
* = $3000
dl.array:
    !byte $70, $70, $70, $42, 0, $40, 2, 2, 2, 2, $F0, 2, 2, 2, 2, $41
    !byte 0, $30
 
* = $2000
main:
; 
;line:21:dli_example.mfk
;     SDLST = dl.addr
    LDA #lo(dl)
    STA $230
    LDA #hi(dl)
...
;     os_VDSLST = dli.addr
    ...
    STA $201
; 
;line:23:dli_example.mfk
;     antic_nmien = $c0
    LDA #$C0
    STA $D40E
; 
;line:25:dli_example.mfk
;     while true {}
.wh__00001:
    BNE .wh__00001
; 
...
segment.default.length         = $9FE5
segment.default.start          = $201B
    ; $0000 = __rwdata_end
    ; $0000 = __rwdata_start
    ; $0000 = os_LINZBS
    ; $0000 = os_LNFLG
    ...
    ; $2019 = .wh__00001
    ; $201B = segment.default.start
    ; $3000 = dl.array
    ; $3000 = dl.first
    ; $3100 = dli
    ; $9FE5 = segment.default.length
    ; $BFFA = os_CARTCS
    ; $BFFA = os_CARTCS.lo
    ; $BFFB = os_CARTCS.hi
    ; $BFFC = os_CART
